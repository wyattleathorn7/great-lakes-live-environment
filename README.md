...
| ☀️ Live Solar Radiation | NOAA/NCEP GFS DSWRF surface analysis (broadband W/m², not UV index), hourly cycles; fixed absolute UV-index-style scale, water-only | LIVE / CURRENT MODEL (analysis), hourly cycles |
